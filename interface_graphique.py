...
tk.Button(page_menu, text="Quel est le podium des écuries à la fin de chaque saison ?",
          command=show_page_podium_ecuries, bg="#0066cc", fg="white", width=90, height=2, wraplength=700).pack(pady=5)

tk.Button(page_menu, text="Quel est le classement des pilotes à l'issu de la saison 2023 ?",
          command=show_page_classement, bg="#0066cc", fg="white", width=90, height=2, wraplength=700).pack(pady=5)
...
tk.Button(page_menu, text="Quel est l'âge moyen des pilote en fonction des années ?",
          command=show_page_age_moyen, bg="#0066cc", fg="white", width=90, height=2, wraplength=700).pack(pady=5)

tk.Button(page_menu, text="Quel est le nombre de best lap time par pilote en 2023 ?",
          command=create_page_best_lap_time_2023, bg="#0066cc", fg="white", width=90, height=2, wraplength=700).pack(pady=5)
...
for question in qa_functions:
    if question not in questions_dynamiques:
        tk.Button(page_menu, text=question, command=lambda q=question: show_page_static(q),
                  bg="#0066cc", fg="white", width=90, height=2, wraplength=700).pack(pady=5)
